package com.qiyue.jia.the_assistant.service;
    ...
    private void updateWeather() {
        ...
        if (weatherString != null) {
            ...
            String weatherUrl = "https://free-api.heweather.com/v5/weather?city=" + weatherId +
                    "&key=3ae81d986c104c8a80b3425dd7267d79";
            HttpUtil.sendOkHttpRequest(weatherUrl, new Callback() {
                ...
                public void onResponse(Call call, Response response) throws IOException {
                    ...
                    Weather weatherInfo = Utility.handleWeatherResponse(responseText);
                    if (weatherInfo !=null && "ok".equals(weather.status)) {
                        SharedPreferences.Editor editor = PreferenceManager.getDefaultSharedPreferences(AutoUpdateService.this).edit();
